function startClassification()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/I_PgyjTyB/',modelReady)
}
function modelReady(){
...
img3=document.getElementById('frog')
